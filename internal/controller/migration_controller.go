...
//+kubebuilder:rbac:groups=flyway.nholuongut.com,resources=migrations,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=flyway.nholuongut.com,resources=migrations/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=flyway.nholuongut.com,resources=migrations/finalizers,verbs=update
